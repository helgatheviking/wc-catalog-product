...
The WC Catalog Product is almost as good as guacamole.

== Installation ==

To install WC Catalog Product:
...
4. After installation has completed you can activate the plugin right away or you can activate the 'WC Catalog Product' extension through the 'Plugins' menu in WordPress at any time

== Plugin Settings ==

WC Catalog Product has several settings
